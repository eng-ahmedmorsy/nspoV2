...
abstract class UrlEndpoint {
  ...
  static getLastRegLocationRequest() =>
      "$baseUrl/Attendance/getLastRegLocationRequest";
  ...
  static deleteRegLocationRequest() =>
      "$baseUrl/Attendance/deleteRegLocationRequest";

  static deleteRequestChangePhone() =>
      "$baseUrl/Attendance/deleteRequestChangePhone";

  static uploadImage() => "$baseUrl/Attendance/UploadImage";
}
